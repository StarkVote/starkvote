...
export function StepConnectWallet({
  ...
  return (
    <div className="flex flex-col items-center gap-6 py-8">
      <div className="flex h-18 w-18 items-center justify-center rounded-2xl border border-white/[0.08] bg-white/[0.04]">
      ...
      <p className="text-base text-slate-500">Connect your Starknet wallet to begin</p>
      <button
        type="button"
