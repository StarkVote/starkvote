        ...
        {isWalletConnected ? (
          <div className="relative">
            <button
              ...
              className="flex items-center gap-2 rounded-full border border-white/[0.08] bg-white/[0.05] px-3 py-1.5 text-xs font-medium text-slate-300 transition hover:bg-white/[0.1]"
            >
            ...
            {menuOpen ? (
              <>
                ...
                <div className="absolute right-0 z-20 mt-2 w-52 overflow-hidden rounded-xl border border-white/[0.08] bg-[#16161e] shadow-2xl">
