...
export const PRIMARY_BUTTON_CLASS =
  "inline-flex h-10 cursor-pointer items-center justify-center rounded-lg bg-gradient-to-r from-violet-600 to-indigo-600 px-5 text-sm font-medium text-white shadow-[0_0_20px_-4px_rgba(139,92,246,0.5)] transition hover:from-violet-500 hover:to-indigo-500 hover:shadow-[0_0_24px_-4px_rgba(139,92,246,0.65)] disabled:cursor-not-allowed disabled:opacity-40 disabled:shadow-none";

export const SECONDARY_BUTTON_CLASS =
  "inline-flex h-10 cursor-pointer items-center justify-center rounded-lg border border-white/[0.1] bg-white/[0.05] px-5 text-sm font-medium text-slate-300 transition hover:bg-white/[0.1] hover:text-white disabled:cursor-not-allowed disabled:opacity-40";
